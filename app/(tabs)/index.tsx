...
const [selectedIndex,setSelectedIndex]  = useState(0)
  ...
  const scrollValue = e.nativeEvent.contentOffset.y+300
  const selectedIndexValue = ((scrollValue)/(Dimensions.get("window").height)).toFixed()
  // console.log(selectedIndexValue)
  setSelectedIndex(selectedIndexValue as any)
  }} style={{marginTop:40,paddingLeft:5,paddingRight:5}}>
...
{DATA.map((item,index)=>{
  return <Post  key={item.id} postData={item} index={index} selectedIndex={selectedIndex} />
})}
